...
/***/ function(module, exports, __webpack_require__) {
	...
	describe('Async', function () {
		...
		it('can be used by extending from it', function () {
			var MyAsync = function (_Async) {
				...
				function MyAsync() {
					...
					Object.defineProperty(_this, 'result', { enumerable: true, get: function get() {
							return _this.getState().result;
						} });
					return _this;
				}
		...
		it('can be used by composing it into other Apis', function (done) {
			var MyAsync = function (_Api) {
				...
				function MyAsync() {
					...
					Object.defineProperty(_this3, 'result', { enumerable: true, get: function get() {
							return _this3.getState().result;
						} });
					return _this3;
				}
		...
		it('has properties `pending`, `busy`, `done` and `error` to inspect it\'s state', function () {
		...
		describe('.error', function () {
			...
			it('returns the error object when there was an error', function () {
				...
				var test = Error('test');
				async.setError(test);
				(0, _chai.expect)(async.error).to.equal(test);
			});
		});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Async = exports.Async = function (_Api) {
		...
		function Async() {
			...
			Object.defineProperty(_this, 'pending', { enumerable: true, get: function get() {
					return _this.getState().async === Async.PENDING;
				} });
			Object.defineProperty(_this, 'busy', { enumerable: true, get: function get() {
					return _this.getState().async === Async.BUSY;
				} });
			Object.defineProperty(_this, 'done', { enumerable: true, get: function get() {
					return _this.getState().async === Async.DONE;
				} });
			Object.defineProperty(_this, 'error', { enumerable: true, get: function get() {
					return _typeof(_this.getState().async) == 'object' && _this.getState().async;
				} });
			return _this;
		}
