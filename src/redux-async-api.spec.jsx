...
describe('Async', () => {
	...
	it('can be used by composing it into other Apis', () => {
	...
	it('has methods `pending`, `busy`, `done` and `error` to inspect it\'s state', () => {
		const async = new Async();
		expect(async).to.have.a.property('pending');
		expect(async.pending).to.be.a('function');
		expect(async).to.have.a.property('busy');
		expect(async.busy).to.be.a('function');
		expect(async).to.have.a.property('done');
		expect(async.done).to.be.a('function');
		expect(async).to.have.a.property('error');
		expect(async.error).to.be.a('function');
	});
